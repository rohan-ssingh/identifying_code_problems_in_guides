...
Based on the current literature review, an AI method to analyze the source code would be best to employ. A Chrome extension would be best employed to extract 
